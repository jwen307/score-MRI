...
if vol:
    if not use_complex:
        new_dir = os.path.join(base_dir, '{0}_{1}_size{2}_centerfrac{3}_accel{4}_vol'.format(challenge,dataset_type,img_size, center_frac, accel_rate))
    else:
        new_dir = os.path.join(base_dir, '{0}_{1}_size{2}_centerfrac{3}_accel{4}_complex_vol'.format(challenge,dataset_type,img_size, center_frac, accel_rate))
else:
    if not use_complex:
