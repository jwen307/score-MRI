...
from data.fastmri_dataset import FastMRIDataModule
from data.fastmri_preprocess_vol_gro import retrieve_metadata, et_query, fetch_dir
from util import util, viz, network_utils
...
if __name__ == '__main__':
    ...
    show_multicoil_combo(data.val[25][0], data.val[25][2])
